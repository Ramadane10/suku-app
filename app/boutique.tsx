...
export default function BoutiqueScreen() {
  ...
  const { products, loading, getProductsByCategory, categories } = useProducts();
      ...
      <View style={styles.searchContainer}>
        ...
        {showFilters && (
          <View style={[styles.filtersContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <Text style={[styles.filterTitle, { color: colors.text }]}>Catégorie</Text>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.categoryFilters}>
              ...
              >
                <Text style={[styles.filterChipText, { color: selectedCategory === null ? '#fff' : colors.text }]}>
                  Toutes
                </Text>
              </TouchableOpacity>
              {categories.map((cat) => (
            ...
            <Text style={[styles.filterTitle, { color: colors.text, marginTop: 16 }]}>Trier par</Text>
              ...
              {[
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.sortButton,
                    { 
                      backgroundColor: sortBy === option.key ? colors.primary : colors.light,
